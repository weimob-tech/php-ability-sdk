...
class WeimobGuideCsMsgSendListRequest implements \JsonSerializable
{
     ...
     */
    public function setParams(?WeimobGuideCsMsgSendListParam $param): void
    {
        $this->params = $param;
    }
     ...
     */
    public function getParams(): ?WeimobGuideCsMsgSendListParam
    {
        return $this->params;
    }
...
class WeimobGuideCsMsgSendListParam implements \JsonSerializable
{
     ...
     */
    public function setServicerId(?int $servicerId): void
    {
     ...
     */
    public function setMsgSourceChannel(?int $msgSourceChannel): void
    {
...
class WeimobGuideCsMsgSendListData implements \JsonSerializable
{
     ...
     */
    public function setFailList(?array $failList): void
    {
