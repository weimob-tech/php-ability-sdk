...
interface PaasUnLockPointService
{
    ...
    public function execute(SUnLockPointRequest $request) : SUnLockPointResponse;
}

class SUnLockPointRequest implements \JsonSerializable
{
    /**
    * 商业操作系统ID（解决方案体系）
    * @var int
...
class SUnLockPointResponse implements \JsonSerializable
{
    /**
     * 请求返回的对象
    ...
    /**
     * @return SUnLockPointData
     */
    public function getData(): ?SUnLockPointData
    {
        return $this->data;
    }

    /**
     * @param SUnLockPointData $data
     */
    public function setData(?SUnLockPointData $data): void
    {
        $this->data = $data;
    }
...
class SUnLockPointData implements \JsonSerializable
{
    /**
     * 解锁的积分
     * @var int
    ...
    /**
     * @param int $unlockPoint
     */
    public function setUnlockPoint(?int $unlockPoint): void
    {
     ...
     * @return int
     */
    public function getUnlockPoint(): ?int
    {
