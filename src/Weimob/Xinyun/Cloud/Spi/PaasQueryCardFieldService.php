...
interface PaasQueryCardFieldService
{
    ...
    public function execute(SQueryCardFieldRequest $request) : SQueryCardFieldResponse;
}

class SQueryCardFieldRequest implements \JsonSerializable
{
    /**
    * 商业操作系统ID（解决方案体系）
    * @var int
...
class SQueryCardFieldResponse implements \JsonSerializable
{
    /**
     * 请求返回的对象
    ...
    /**
     * @return SQueryCardFieldData
     */
    public function getData(): ?SQueryCardFieldData
    {
        return $this->data;
    }

    /**
     * @param SQueryCardFieldData $data
     */
    public function setData(?SQueryCardFieldData $data): void
    {
        $this->data = $data;
    }
...
class SQueryCardFieldData implements \JsonSerializable
{
