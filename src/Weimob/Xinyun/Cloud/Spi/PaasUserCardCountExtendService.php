...
interface PaasUserCardCountExtendService
{
    ...
    public function execute(SUserCardCountExtendRequest $request) : SUserCardCountExtendResponse;
}

class SUserCardCountExtendRequest implements \JsonSerializable
{
    /**
    * 商业操作系统ID（解决方案体系）
    * @var int
...
class SUserCardCountExtendResponse implements \JsonSerializable
{
    /**
     * 请求返回的对象
    ...
    /**
     * @return SUserCardCountExtendData
     */
    public function getData(): ?SUserCardCountExtendData
    {
        return $this->data;
    }

    /**
     * @param SUserCardCountExtendData $data
     */
    public function setData(?SUserCardCountExtendData $data): void
    {
        $this->data = $data;
    }
