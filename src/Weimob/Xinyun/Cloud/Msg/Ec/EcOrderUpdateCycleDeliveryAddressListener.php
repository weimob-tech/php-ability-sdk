...
class UpdateCycleDeliveryAddressMessage implements \JsonSerializable
{
     ...
     */
    public function setEnableDelivery(?string $enableDelivery): void
    {
     ...
     */
    public function setReceiverArea(?string $receiverArea): void
    {
     ...
     */
    public function setReceiverLongitude(?string $receiverLongitude): void
    {
     ...
     */
    public function setReceiverLatitude(?string $receiverLatitude): void
    {
     ...
     */
    public function setReceiverZip(?string $receiverZip): void
    {
