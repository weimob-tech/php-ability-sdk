 ...
 * @create 2022年11月20日
 */
interface WeimobShopPromotionActivityCreateListener
{
    const topic = 'weimob_shop.promotion';
    const event = 'activityCreate';
    const classType = ActivityCreateMessage::class;
    const specType = 'wos';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class ActivityCreateMessage implements \JsonSerializable
{
    /**
     * 活动id
     * @var int
