...
class StatusUpdateMessage implements \JsonSerializable
{
    ...
    */
    public function setRightsInfo(?WeimobShopRightsStatusUpdateRightsInfo $rightsInfo)
    {
    ...
    */
    public function setOrderInfo(?WeimobShopRightsStatusUpdateOrderInfo $orderInfo)
    {
