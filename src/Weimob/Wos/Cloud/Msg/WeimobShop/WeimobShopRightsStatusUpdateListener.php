 ...
 * @create 2022年11月20日
 */
interface WeimobShopRightsStatusUpdateListener
{
...
class StatusUpdateMessage implements \JsonSerializable
{
    /**
     * 售后信息
     * @var WeimobShopRightsStatusUpdateRightsInfo
     */
    private $rightsInfo;

    /**
     * 订单信息
     * @var WeimobShopRightsStatusUpdateOrderInfo
     */
    private $orderInfo;
    ...
    /**
     * @param WeimobShopRightsStatusUpdateRightsInfo $rightsInfo
     */
    public function setRightsInfo(?WeimobShopRightsStatusUpdateRightsInfo $rightsInfo): void
    {
        $this->rightsInfo = $rightsInfo;
    }

    /**
     * @return WeimobShopRightsStatusUpdateRightsInfo
     */
    public function getRightsInfo(): ?WeimobShopRightsStatusUpdateRightsInfo
    {
        return $this->rightsInfo;
    }

    /**
     * @param WeimobShopRightsStatusUpdateOrderInfo $orderInfo
     */
    public function setOrderInfo(?WeimobShopRightsStatusUpdateOrderInfo $orderInfo): void
    {
        $this->orderInfo = $orderInfo;
    }

    /**
     * @return WeimobShopRightsStatusUpdateOrderInfo
     */
    public function getOrderInfo(): ?WeimobShopRightsStatusUpdateOrderInfo
    {
...
class WeimobShopRightsStatusUpdateRightsInfo implements \JsonSerializable
{
    /**
     * 销售节点
     * @var int
...
class WeimobShopRightsStatusUpdateOrderInfo implements \JsonSerializable
{
    /**
     * 父订单号
     * @var int
