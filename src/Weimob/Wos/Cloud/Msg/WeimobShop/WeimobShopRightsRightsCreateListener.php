...
class RightsCreateMessage implements \JsonSerializable
{
    ...
    */
    public function setRightsInfo(?WeimobShopRightsRightsCreateRightsInfo $rightsInfo)
    {
    ...
    */
    public function setOrderInfo(?WeimobShopRightsRightsCreateOrderInfo $orderInfo)
    {
