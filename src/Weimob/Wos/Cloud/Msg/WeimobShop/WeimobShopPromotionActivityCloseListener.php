 ...
 * @create 2022年11月18日
 */
interface WeimobShopPromotionActivityCloseListener
{
    const topic = 'weimob_shop.promotion';
    const event = 'activityClose';
    const classType = ActivityCloseMessage::class;
    const specType = 'wos';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class ActivityCloseMessage implements \JsonSerializable
{
    /**
    * 活动id
    * @var int
