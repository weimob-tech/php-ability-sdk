 ...
 * @create 2022年11月18日
 */
interface WeimobShopPromotionActivityUpdateListener
{
    const topic = 'weimob_shop.promotion';
    const event = 'activityUpdate';
    const classType = ActivityUpdateMessage::class;
    const specType = 'wos';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class ActivityUpdateMessage implements \JsonSerializable
{
    /**
    * 活动id
    * @var int
