 ...
 * @create 2022年11月18日
 */
interface WeimobShopPromotionActivityGoodsUpdateListener
{
    const topic = 'weimob_shop.promotion';
    const event = 'activityGoodsUpdate';
    const classType = ActivityGoodsUpdateMessage::class;
    const specType = 'wos';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class ActivityGoodsUpdateMessage implements \JsonSerializable
{
    /**
    * 活动id
    * @var int
