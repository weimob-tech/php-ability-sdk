 ...
 * @create 2022年11月18日
 */
interface WeimobShopPromotionActivityStartListener
{
    const topic = 'weimob_shop.promotion';
    const event = 'activityStart';
    const classType = ActivityStartMessage::class;
    const specType = 'wos';

    public function onMessage(WeimobMessage $message) : WeimobMessageAck;
}

class ActivityStartMessage implements \JsonSerializable
{
    /**
    * 活动id
    * @var int
