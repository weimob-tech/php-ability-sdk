 ...
 * @create 2023-5-23
 */
interface BosUserShippingaddressCreateListener
{
...
class CreateMessage implements \JsonSerializable
{
    /**
     * 收货地址详细信息
     * @var BosUserShippingaddressCreateAddressInfo
     */
    private $addressInfo;
    ...
    /**
     * @param BosUserShippingaddressCreateAddressInfo $addressInfo
     */
    public function setAddressInfo(?BosUserShippingaddressCreateAddressInfo $addressInfo): void
    {
        $this->addressInfo = $addressInfo;
    }

    /**
     * @return BosUserShippingaddressCreateAddressInfo
     */
    public function getAddressInfo(): ?BosUserShippingaddressCreateAddressInfo
    {
...
class BosUserShippingaddressCreateAddressInfo implements \JsonSerializable
{
    /**
     * 收货地址唯一id
     * @var int
    ...
    /**
     * 地图类型(1, "高德地图"),(2, "谷歌地图"),(3, "百度地图"),(4, "腾讯地图")
     * @var int
     */
    private $mapType;
