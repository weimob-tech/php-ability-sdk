...
class UpdateMessage implements \JsonSerializable
{
     ...
     */
    public function setOperateRelations(?array $operateRelations): void
    {
...
class BosEmployeeRoleUpdateOperateRelations implements \JsonSerializable
{
     ...
     */
    public function setVidRelationDetailList(?array $vidRelationDetailList): void
    {
     ...
     */
    public function setExtendAttr(?string $extendAttr): void
    {
