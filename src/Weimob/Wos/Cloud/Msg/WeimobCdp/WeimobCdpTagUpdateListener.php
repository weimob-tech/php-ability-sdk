...
class UpdateMessage implements \JsonSerializable
{
    ...
    */
    public function setOpenAttrInfoVos(?array $openAttrInfoVos)
    {
    ...
    */
    public function setTagColor(?string $tagColor)
    {
    ...
    * @param int $attType
    */
    public function setAttType(?int $attType)
    {
    ...
    */
    public function setTagSource(?string $tagSource)
    {
    ...
    */
    public function setTagDataUpdateTime(?string $tagDataUpdateTime)
    {
    ...
    */
    public function setBizViewFilterJson(?string $bizViewFilterJson)
    {
...
class WeimobCdpTagUpdateOpenAttrInfoVos implements \JsonSerializable
{
    ...
    */
    public function setAttrEvent(?string $attrEvent)
    {
