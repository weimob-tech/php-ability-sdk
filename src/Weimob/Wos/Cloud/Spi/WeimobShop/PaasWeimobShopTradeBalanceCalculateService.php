...
class WeimobShopTradeBalanceCalculateParam implements \JsonSerializable
{
     ...
     */
    public function setBasicInfo(?WeimobShopTradeBalanceCalculateParamBasicInfo $basicInfo): void
    {
     ...
     */
    public function setExtendInfo(?WeimobShopTradeBalanceCalculateParamExtendInfo $extendInfo): void
    {
...
class WeimobShopTradeBalanceCalculateParamGoodsTradeMetas implements \JsonSerializable
{
     ...
     */
    public function setBasicGoodsInfo(?WeimobShopTradeBalanceCalculateParamBasicGoodsInfo $basicGoodsInfo): void
    {
     ...
     */
    public function setMutex(?WeimobShopTradeBalanceCalculateParamMutex $mutex): void
    {
        $this->mutex = $mutex;
    }
     ...
     */
    public function setPostageDiscountInfo(?WeimobShopTradeBalanceCalculateParamPostageDiscountInfo $postageDiscountInfo): void
    {
     ...
     */
    public function setTradeGoodsInfo(?WeimobShopTradeBalanceCalculateParamTradeGoodsInfo $tradeGoodsInfo): void
    {
...
class WeimobShopTradeBalanceCalculateParamBasicGoodsInfo implements \JsonSerializable
{
     ...
     */
    public function setPreSellInfo(?WeimobShopTradeBalanceCalculateParamPreSellInfo $preSellInfo): void
    {
...
class WeimobShopTradeBalanceCalculateParamPostageDiscountInfo implements \JsonSerializable
{
     ...
     */
    public function setMutex(?WeimobShopTradeBalanceCalculateParamMutex2 $mutex): void
    {
        $this->mutex = $mutex;
    }
...
class WeimobShopTradeBalanceCalculateData implements \JsonSerializable
{
     ...
     */
    public function setEnableInputBalance(?bool $enableInputBalance): void
    {
...
class WeimobShopTradeBalanceCalculateDataGoodsTradeMetas implements \JsonSerializable
{
     ...
     */
    public function setTradeGoodsInfo(?WeimobShopTradeBalanceCalculateDataTradeGoodsInfo $tradeGoodsInfo): void
    {
        $this->tradeGoodsInfo = $tradeGoodsInfo;
    }
     ...
     */
    public function setPostageDiscountInfo(?WeimobShopTradeBalanceCalculateDataPostageDiscountInfo $postageDiscountInfo): void
    {
        $this->postageDiscountInfo = $postageDiscountInfo;
    }
...
class WeimobShopTradeBalanceCalculateDataPostageDiscountInfo implements \JsonSerializable
{
     ...
     */
    public function setMutex(?WeimobShopTradeBalanceCalculateDataMutex $mutex): void
    {
        $this->mutex = $mutex;
    }
...
class WeimobShopTradeBalanceCalculateDataCalcRuleList implements \JsonSerializable
{
     ...
     */
    public function setMutex(?WeimobShopTradeBalanceCalculateDataMutex2 $mutex): void
    {
        $this->mutex = $mutex;
    }
     ...
     */
    public function setDiscountUseInfo(?WeimobShopTradeBalanceCalculateDataDiscountUseInfo $discountUseInfo): void
    {
