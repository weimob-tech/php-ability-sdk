...
class WeimobGuideCustomerConsumeGetListData implements \JsonSerializable
{
     ...
     */
    public function setTotalConsumptionAmount(?int $totalConsumptionAmount): void
    {
     ...
     */
    public function setTotalConsumptionCount(?int $totalConsumptionCount): void
    {
     ...
     */
    public function setLastPayTime(?int $lastPayTime): void
    {
