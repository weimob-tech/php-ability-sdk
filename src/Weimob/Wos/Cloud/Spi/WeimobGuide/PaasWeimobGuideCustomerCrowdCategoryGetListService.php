...
class WeimobGuideCustomerCrowdCategoryGetListRequest implements \JsonSerializable
{
     ...
     */
    public function setParams(?WeimobGuideCustomerCrowdCategoryGetListParam $param): void
    {
        $this->params = $param;
    }
     ...
     */
    public function getParams(): ?WeimobGuideCustomerCrowdCategoryGetListParam
    {
        return $this->params;
    }
...
class WeimobGuideCustomerCrowdCategoryGetListParam implements \JsonSerializable
{
     ...
     */
    public function setCrowdIds(?array $crowdIds): void
    {
...
class WeimobGuideCustomerCrowdCategoryGetListData implements \JsonSerializable
{
     ...
     */
    public function setCategoryInfoList(?array $categoryInfoList): void
    {
